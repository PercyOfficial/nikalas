...
Available commands are:
 - /setlang: set your preferred language.""",
    ...
    # __main__
    "Ada yang bisa saya bantu? 😊": "පෝර්පින්ටන් මගේ ජීවිතයේ කිසි විටෙකත් බියගුලුකමට වරදකරුවෙකු වී නැති බව මම විශ්වාස කරමි! මගේ නහර තුළ දිවෙන උතුම් රුධිරය  මෙයට සාක්ෂි දරයි !!! මගෙන් වෙන්න ඕන මොකක්ද",
    "start_text": """
...
මගෙන් කරගන්න පුලුවන් උදව් ටික පල්ලෙහා තියනව
*Main* commands available:
 - /start: නිකලස් එක ආරම්භ කරන්න.
...
""",
    ...
    "Terbanned! 😝": "ඌට කෙලියෝ! 😝",
    "Yah sial, aku tidak bisa banned pengguna itu 😒": "මට ඌට කෙලින්න බෑනේ 😒",
    ...
    "Saya tidak akan menendang diri saya sendiri, apakah kamu gila? 😠":"මම මටම පයින් ගහගන්නෑ මනුස්සයෝ",
...
RUN_STRINGS = (
    ...
    "බෙල්ල කැඩිච්ච නිකලස් කියල දුවල මට අහුවෙනව  නෙමෙයි",
    "❤"
    "ඔයත් ආසද HOGWATTS[🏭](https://t.me/joinchat/wPEojnfzfdcwMmU1)",
    "10 points to Grifindore",
    "පෝර්පින්ටන් මගේ ජීවිතයේ කිසි විටෙකත් බියගුලුකමට වරදකරුවෙකු වී නැති බව මම විශ්වාස කරමි! මගේ නහර තුළ දිවෙන උතුම් රුධිරය  මෙයට සාක්ෂි දරයි !!!",
    "පෝර්පින්ටන් මගේ ජීවිතයේ කිසි විටෙකත් බියගුලුකමට වරදකරුවෙකු වී නැති බව මම විශ්වාස කරමි! මගේ නහර තුළ දිවෙන උතුම් රුධිරය  මෙයට සාක්ෂි දරයි !!!",
    "ඔය බටොන් එක ඔබන එක දැන්වත් නවත්තන්න ",
)
